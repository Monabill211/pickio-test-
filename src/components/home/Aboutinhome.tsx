...
export default function Aboutinhome() {
  return (
    <div >
      <div className='bg-red-500 flex justify-around text-center text-white' style={{padding:'30px'}}>
      ...
      <div className='flex justify-between bg-gray-200 'style={{paddingTop:'20px'}}>
...
<Link to="/about">
<button className='bg-red-500 text-white py-2 px-4 rounded-3xl text-center transition-all duration-300 ease-in-out hover:bg-red-600 cursor-pointer hover:-translate-y-2' style={{marginRight:'38%'}}>معرفة المزيد عن Pickio </button>
</Link>
        </div>
      </div>
    </div>
