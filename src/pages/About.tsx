          ...
          <div className="container">
            <div className="mx-auto max-w-3xl text-center">
              ...
              >
                {isRTL
                  ?
               '   Furniture Pickio هي شركة مصرية متخصصة في تصنيع وتوريد األثاث المكتبي الراقي، تجمع بين خبرة التصنيع وجودة الخامات والتصميم العصري لتقديم حلول متكاملة تلبي احتياجات الشركات والمساحات اإلدارية الحديثة.نفخر بامتالكنا مصنعًا مجهزًا بأحدث التقنيات ومعارض متعددة،مما يتيح لنا تقديم تجربة متكاملة تبدأ من التصميم واإلنتاج وحتى التسليم والتركيب، مع االلتزام بأعلى معايير الجودة والدقة في التنفيذ.نؤمن بأن لكل عميل رؤية مختلفة، لذلك نوفر خدمة التصميم والتصنيع حسب الطلب )Customization)، حيث يمكن تنفيذ وتعديل المقاسات، والخامات، واأللوان، وتخصيص أي موديل بما يتناسب مع هوية الشركة واحتياجاتها العملية.على مدار سنوات من الخبرة، نجحنا في بناء ثقة عمالئنا من خالل تقديم منتجات تجمع بين الفخامة، والعملية، والمتانة، لنصنع مساحات عمل تعكس االحترافية وتدوم لسنوات.Furniture Pickio …نصنع بيئات عمل استثنائية تجمع بين الجودة، واالبتكار، والتفاصيل التي تصنع'
